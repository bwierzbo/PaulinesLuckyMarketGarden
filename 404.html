...
<head>
	<title>Agro Crop Agriculture Category Bootstrap Responsive Web Template | 404 Error Page :: W3layouts</title>
	<!-- Meta tag Keywords -->
...
<body>
				...
				<ul class="navbar-nav mr-auto ml-xl-5 ml-lg-3 px-xl-5 px-lg-4 py-4 text-center">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<a class="dropdown-item active" href="404.html">404 Error Page</a>
						</div>
					</li>
					<li class="nav-item mx-lg-4 my-lg-0 my-3">
	...
	<div class="error_banner">
		<div class="container-fluid">
			<div class="agileinfo-error">
				<div class="error_grid offset-lg-6 offset-md-5 offset-sm-4 offset-1">
					<h4>Oop's!
						<i class="fas fa-frown ml-3"></i>
					</h4>
					<h5 class="d-flex">404
						<sup class="d-flex align-items-center ml-3">Error Page</sup>
					</h5>
					<a href="index.html" class="button-w3ls-2">Back Home</a>
				</div>
			</div>
		</div>
	</div>
